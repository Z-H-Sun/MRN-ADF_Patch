...
print("\e]0;View CTI Output by Zack\a")
...
def readout(filename, fileout)
    ...
    while not f.eof
        ...
        param[ind] = l[/(?<=:).*/].strip unless ind.nil?
    end
...
begin
    ...
    puts "\n\e[1;33mFound \e[1;32m#{fs.size}\e[1;33m .out file(s) in this folder: \e[0m" + File.absolute_path('.')
    ...
    puts "\e[1;31m"
    puts $!
    print "\e[0mPress Enter to continue."; STDIN.gets
    print "\ec"
    retry
rescue
    puts "\e[1;31m"
